...
export default function RacuniModule({ onExit }) {
    ...
    const [sveTransakcije, setSveTransakcije] = useState([]); // Za sinhronizaciju kase
    ...
    const load = async () => {
        ...
        const {data: b} = await supabase.from('blagajna').select('*'); setSveTransakcije(b||[]);
