        ...
        <div>
          ...
          <div className="grid grid-cols-12 gap-6 mb-6">
            <div className="col-span-5">
              <h3 className="font-bold text-white text-[11px] p-1.5 px-2 mb-2" style={{ backgroundColor: tamnoPlava, WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>LOG INPUT (Ulaz Trupaca)</h3>
            ...
            <div className="col-span-7">
              <h3 className="font-bold text-white text-[11px] p-1.5 px-2 mb-2" style={{ backgroundColor: tamnoPlava, WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>PRODUCT OUTPUT (Izlaz Gotove Robe)</h3>
          ...
          {/* 4. GRAFIKONI */}
          <h3 className="font-bold text-white text-[11px] p-1.5 px-2 mb-3 print:mt-4" style={{ backgroundColor: tamnoPlava, WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>VIZUELNA ANALIZA PROREZA</h3>
              ...
              <ul className="text-[9px] space-y-1">
                {data.zastoji.map((z, i) => (
                  <li key={i} className="flex gap-2">
                    ...
                    {z.zastoj_min > 0 && <span className="font-black text-red-600 bg-red-100 px-1 rounded" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>Zastoj: {z.zastoj_min} min</span>}
